...
{
    [FormerlySerializedAs("ui_Back")] [SerializeField]
    private AudioClip uiBack;

    [FormerlySerializedAs("ui_Confirm")] [SerializeField]
    private AudioClip uiConfirm;

    [FormerlySerializedAs("ui_Impact")] [SerializeField]
    private AudioClip uiImpact;

    [FormerlySerializedAs("ui_StartGame")] [SerializeField]
    private AudioClip uiStartGame;

    [FormerlySerializedAs("ui_Navigate")] [SerializeField]
    private AudioClip uiNavigate;
