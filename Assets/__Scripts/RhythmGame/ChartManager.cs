...
namespace SaturnGame.RhythmGame
{
    public class ChartManager : MonoBehaviour
    {
        ...
        public async Task<bool> LoadChart(Stream merStream)
        {
            if (merStream == null)
            {
                Debug.LogWarning("File stream is null! Aborting...");
                return false;
            }
        ...
        private float CalculateTime(ChartObject chartObject)
        {
            ...
            return tickTime * SaturnMath.tickToMeasure;
        }
        ...
        public void LoadChartLegacy(Stream merStream)
        {
